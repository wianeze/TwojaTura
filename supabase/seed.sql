...
insert into public.meetings (
  id, created_by, title, description, location, status, starts_at, ends_at
)
values
  (
    ...
    '10000000-0000-0000-0000-000000000001',
    'Lipcowe granie',
    'Letni wieczór planszówkowy w przygotowaniu.',
    'Górska Chata',
    'planned',
    '2026-07-17 16:00:00+00',
    '2026-07-17 21:00:00+00'
  ),
  (
    ...
    '2026-07-11 22:00:00+00'
  ),
  (
    '40000000-0000-0000-0000-000000000003',
    '10000000-0000-0000-0000-000000000003',
    'Czerwcowy finał',
    'Spotkanie zakończone bez zapisu partii.',
    'U Marty',
    'completed',
    '2026-06-27 16:00:00+00',
...
values
  ('40000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000002', true),
  ('40000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000004', true),
  ('40000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000003', false),
  ('40000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002', true),
  ('40000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000003', true);
...
-- Ostatni wiersz to odpowiedź odmowna: kandydat zostaje na liście z własnym
-- licznikiem, mimo że nie każdy chce w niego zagrać.
insert into public.meeting_game_responses (
  meeting_id, game_id, user_id, wants_to_play
)
values
  ('40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000002', true),
  ('40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000002', true),
  ('40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000001', '10000000-0000-0000-0000-000000000003', true),
  ('40000000-0000-0000-0000-000000000001', '30000000-0000-0000-0000-000000000002', '10000000-0000-0000-0000-000000000003', false);
