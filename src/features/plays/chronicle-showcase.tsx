const chronicleEntries = [
  {
    ...
    duration: "82 min",
    players: ["M", "A", "K", "J"],
    note: "Najdłuższy szlak wieczoru powstał tuż przed ostatnią rundą.",
    marker: "bg-moss",
  },
  {
    date: "14 czerwca 2026",
    game: "Ostatnia Latarnia",
    winner: "Wspólne zwycięstwo",
    duration: "108 min",
    players: ["A", "K", "M"],
    note: "Latarnia zapłonęła w ostatnim możliwym ruchu. Było blisko.",
    marker: "bg-accent",
  },
  {
    date: "31 maja 2026",
    game: "Portowe Opowieści",
    winner: "Kuba",
    duration: "64 min",
    players: ["K", "J", "A", "M"],
    note: "Wieczór zakończony handlem przyprawami i jednym bardzo ryzykownym rejsem.",
    marker: "bg-gold",
  },
];
